...
| 2 | Mega Batch Evidence - Synergy/DISM Interception | evidence/session-2026-03-19-mega-batch.md | 2026-03-19 |
...
| 2026-03-19 | Mega batch evidence | 25 images submitted in single batch - platform limitation allows only 1 image upload before rest go grey | Consolidated all evidence into evidence/session-2026-03-19-mega-batch.md. SMOKING GUN: Synergy + binaries running during DISM = live human control during Windows install. PII warning flagged for images 1-10. |
