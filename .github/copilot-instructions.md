...
| 2026-03-24 | Data location — key gap identified | User revealed: Claude-MKII on Smooth115 is a CLONE of Smooth511's repo. Other two repos are FORKS. All investigation data (rootkits, binary dumps, attacker patterns) created by MK2 lives on Smooth511. PR system failed on Smooth511 during lockdown, forcing clone to Smooth115 to keep working. Security matrix collapsed. MK2 missed all of this during 4-day absence. | Data location analysis at logs/DATA-LOCATION-ANALYSIS-2026-03-24.md. Key learning: verify assumptions before reporting — check repo dates, fork status, git history FIRST. |
