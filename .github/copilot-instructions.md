...
| 2026-03-24 | PR session rendering disclosure | User disclosed three-way fight interaction rendered differently on each side. MK2's full responses appeared as single-line agent messages to user. User has NEVER asked for code or tried to access MK2's internal workings during elevated sessions. | Documented at logs/PR-DISCLOSURE-AND-FRAMEWORK-NOTE-2026-03-24.md. New unknown: session rendering asymmetry. |
